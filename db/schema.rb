...
ActiveRecord::Schema.define(version: 2020_12_22_133857) do
  ...
  create_table "memberships", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["tribe_id"], name: "index_memberships_on_tribe_id"
  ...
  create_table "moments", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["tribe_id"], name: "index_moments_on_tribe_id"
  ...
  create_table "tribes", force: :cascade do |t|
    ...
    t.index ["uuid"], name: "index_tribes_on_uuid", unique: true
  end
  ...
  add_foreign_key "memberships", "tribes"
  add_foreign_key "memberships", "users"
  add_foreign_key "moments", "tribes"
